...
<section class="content-section">
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-3">
                <figure>
                    <img src="{{ asset('assets/images/qorqud.png') }}" width="50px;" alt="Image">
                </figure>
            </div>
            <!-- end col-3 -->
        </div>
        ...
        <div class="row justify-content-center">
            @foreach($children AS $child)
                <div class="col-lg-4 col-md-6">
                    <div class="exhibition-box" data-scroll data-scroll-speed="-1" >
                        <figure> <a href="#"><img src="{{ asset("storage/" . $child->photo[0]) }}" alt="Image" class="img"></a>
                            <div class="info">
                                <figure class="i"><img src="assets/images/icon-info.png" alt="Image"></figure>
                                <span>Ətraflı</span> </div>
                            <!-- end info -->
                        </figure>
                        <div class="content-box">
                            <h4><a href="#">{{ $child->title }}</a></h4>
                        </div>
                        <!-- end content-box -->
                    </div>
                    <!-- end exhibition-box -->
            ...
            @endforeach
            <!-- end col-4 -->
            <div class="col-12 text-center"> <a href="#" class="custom-button">Hamısına bax</a> </div>
            <!-- end col-12 -->
        </div>
        <!-- end row -->
    </div>
