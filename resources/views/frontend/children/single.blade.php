    ...
    <section class="content-section" style="font-size: 20px; ">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="blog-post">
                        ...
                        <section class="slider container " style="height: 440px; width: 100%">
                            <div class="swiper-container slider-images">
                                <div class="swiper-wrapper">
                                    @foreach($children->photo AS $slide)
                        ...
                        <div class="content-box">
                            ...
                            <p >{!! \App\Helpers\MarkdownHelper::toHtml($children->content) !!}</p>
                        </div>
                        <!-- end content-box -->
                    </div>
                    <!-- end blog-post -->
                ...
                @if(!empty($children->video))
                <div class="col-lg-4 col-md-6">
                    <div class="widget">
                    <div class="exhibition-box" data-scroll data-scroll-speed="-1" >
                        <figure> <a href="#"><img src="{{ asset("storage/" . $children->photo[0]) }}" alt="Image" class="img"></a>



                            <!-- end info -->
                        </figure>
                        <div class="play-now"> <a href="{{ asset("storage/" . $children->video) }}" data-fancybox data-width="640" data-height="360"  class="play-btn"></a>
