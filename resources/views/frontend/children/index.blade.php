                        ...
                        <div class="exhibition-box" data-scroll data-scroll-speed="-1" >
                            <figure> <a href="{{ route('children.show' , $child->id) }}"><img src="{{ asset("storage/" . $child->photo[0]) }}" alt="Image" class="img"></a>
                                <div class="info">
                                    ...
                                    <span><a href="{{ route('children.show' , $child->id) }}">Ətraflı oxu </a></span> </div>
                                <!-- end info -->
                            </figure>
                            <div class="content-box">
                                <h4><a href="{{ route('children.show' , $child->id) }}">{{ \Illuminate\Support\Str::limit($child->title, 25) }}</a></h4>
