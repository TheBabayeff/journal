                ...
                @foreach($galleries AS $gall)
                    <div class="col-lg-4 col-md-6">
                        <div class="exhibition-box" data-scroll data-scroll-speed="-1" >
                            <figure> <a href="{{ route('gallery.show' , $gall->id) }}"><img src="{{ asset("storage/" . $gall->image[0]) }}" alt="Image" class="img"></a>
                                <div class="info">
                                    <figure class="i"><img src="{{ asset("assets/images/icon-info.png") }}" alt="Image"></figure>
                                    <span><a href="{{ route('gallery.show' , $gall->id) }}">Ətraflı</a></span> </div>
                                <!-- end info -->
                            </figure>
                            <div class="content-box">
                                <h4><a href="{{ route('gallery.show' , $gall->id) }}">{{ \Illuminate\Support\Str::limit($gall->title, 25) }}</a></h4>
