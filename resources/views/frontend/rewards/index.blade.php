...
@section('content')
    <header class="page-header" data-background="images/page-header.jpg">
        <div class="inner">
            ...
            <h1>Məqalələr</h1>
            <p>Azərbaycan Dünyası Türk dünyasının görən gözü, eşidən sözü, duyan ürəyidir </p>
        </div>
        <!-- end inner -->
    </header>
    <!-- end page-header -->
                        ...
                        <div class="exhibition-box" data-scroll data-scroll-speed="-1" >
                            <figure> <a href="{{ route('rewards.show' , $rewards->id) }}"><img src="{{ asset("storage/" . $rewards->photo[0]) }}" alt="Image" class="img"></a>
                                <div class="info">
                                    ...
                                    <span><a href="{{ route('rewards.show' , $rewards->id) }}">Ətraflı oxu </a></span> </div>
                                <!-- end info -->
                            </figure>
                            <div class="content-box">
                                <h4><a href="{{ route('rewards.show' , $rewards->id) }}">{{ \Illuminate\Support\Str::limit($rewards->title, 25) }}</a></h4>
